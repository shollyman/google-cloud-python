...
from google.cloud.bigquery.model import ModelListItem
...
class Client(ClientWithProject):
    ...
    def list_models(
        ...
        Returns:
            google.api_core.page_iterator.Iterator:
                Iterator of
                :class:`~google.cloud.bigquery.table.ModelListItem` contained
...
def _item_to_model(iterator, resource):
    ...
    :type resource: dict
    :param resource: An item to be converted to a model.

    :rtype: :class:`~google.cloud.bigquery.model.Model`
    :returns: The next model in the page.
    """
    return ModelListItem(resource)
